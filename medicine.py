...
if __name__ == '__main__':
    ...
    if os.path.exists('medi.html'):
        os.rename('medi.html', 'templates/medi.html')
    elif not os.path.exists('templates/medi.html'):
        raise FileNotFoundError("medi.html not found")
